...
### Features
- Added user profile editing (#456)

### Bug Fixes
- Fixed login crash on invalid credentials (#789)

### Improvements
- Updated database schema for performance

**Commit Message:**  
"Release v1.2.3: Profile editing, login bug fix, DB improvements (#456, #789)"
...
**References:**  
[#456](https://github.com/org/repo/issues/456), [#789](https://github.com/org/repo/issues/789)
```
