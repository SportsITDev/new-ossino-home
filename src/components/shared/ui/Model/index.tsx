    ...
    return (
        <>
            ...
            ${isVisible ? "opacity-100" : "opacity-0"}`}
                >
                    <div
                        className={`relative m-2 p-2 lg:m-4 lg:p-4 rounded-lg border-gray-800 xl:border-gray-700 bg-gray-800 shadow-sm transform transition-all duration-300 no-scrollbar
