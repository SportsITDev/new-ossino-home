...
const CircleProgress = ({
  ...
  return (
    <div className="relative w-full h-full">
      ...
      >
        <Path
          className={cn('opacity-5 stroke-gray-700', bgClassName)}
          dashRatio={1}
        ...
        <Path
          className={cn(
            'stroke-neon-1 stroke-linecap-round origin-center -scale-x-100',
            mainClassName,
          )}
          dashRatio={pathRatio}
          pathRadius={pathRadius}
        ...
        <Path
          className={cn(
            'stroke-neon-1 stroke-linecap-round origin-center -scale-x-100 blur-[2px]',
            secondaryClassName,
          )}
          dashRatio={pathRatio}
          pathRadius={pathRadius}
