                ...
                <div>
                    <nav aria-label="Pagination" className="isolate inline-flex -space-x-px rounded-md">
                        ...
                        <button
                            disabled={currentPage === 1}
                            onClick={() => onPageChange?.(currentPage - 1)}
                            className="relative inline-flex items-center rounded-1-md px-2 py-2 text-gray-400 inset-ring inset-ring-gray-700 hover:bg-white/5 focus:z-20 focus:outline-offset-0 disabled:opacity-40"
                        >
                    ...
                    ${page === currentPage
                                            ? "z-10 border-gray-800 xl:border-gray-700 bg-gray-700 text-white rounded-lg"
                        ...
                        <button
                            disabled={currentPage === totalPages}
                            onClick={() => onPageChange?.(currentPage + 1)}
                            className="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 inset-ring inset-ring-gray-700 hover:bg-white/5 focus:z-20 focus:outline-offset-0 disabled:opacity-40"
                        >
