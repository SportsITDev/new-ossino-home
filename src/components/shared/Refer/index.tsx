...
const Refer = ({ onInvite }: ReferProps) => {
  return (
    <div className="rounded-xl backdrop-blur-[210px] p-4 pb-5 relative overflow-hidden bg-gradient-to-b from-[3%] from-[#011504] to-95% to-[#3f803c] w-full">
      <div className="relative z-10">
        <p className="font-black mb-0.5 text-white">REFER A FRIEND</p>
        <p className="max-w-52 text-xs mb-2 text-white">
