    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-medium text-gray-200">Filter Referrals</h3>
          <Button
            onClick={onClose}
            className="h-10 w-10 p-0 bg-transparent hover:bg-gray-700"
          >
            <Icon id="closeIcon" href={close} className="w-5 h-5 stroke-gray-400" />
          </Button>
        </div>
          ...
          <div>
            <label className="flex items-center space-x-2">
              <input
                ...
                className="rounded border-gray-600 text-neon-1 focus:ring-neon-1"
              />
              <span className="text-sm text-gray-300">Show only referrals with earnings</span>
            </label>
          </div>
        </div>
        ...
        <div className="flex gap-2 mt-6">
          ...
          <Button
            ...
            className="flex-1 bg-neon-1 hover:bg-neon-1/80 text-black"
          >
            Apply Filters
          </Button>
        </div>
