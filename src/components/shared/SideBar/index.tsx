    ...
    <div className="relative flex flex-col h-screen w-[250px] xl:w-[250px] md:w-[400px] z-[2000] side-bar-scroll">
      ...
      >
        ...
        <Button
          ...
          className={cn(
            'border-gray-700 rounded-lg border hidden text-white bg-transparent w-8 h-8 p-0 md:flex items-center justify-center',
            { 'lg:ml-1': !isOpen },
          )}
        >
          <Icon
      ...
      <nav className="w-full flex-1 overflow-auto p-5 pt-0">
        ...
        />
        {/* Only show Categories heading on homepage and when sidebar is open */}
