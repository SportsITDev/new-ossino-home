...
const PageHeaderBalance = () => {
  ...
  if (coinsOverviewError) {
    return (
      <div className="bg-gray-800 rounded-lg h-8 font-semibold px-4 flex items-center gap-2 w-fit text-status-error-200">
        Error
      </div>
    );
  }
  ...
  if (coinsOverviewLoading) {
    return (
      <div className="bg-gray-800 rounded-lg h-8 px-4 flex items-center gap-2 w-fit">
