...
const UserCard = () => {
  ...
  if (loyaltyDetailsError) {
    ...
    return (
      <div className="flex-1 min-h-[145px] xl:min-h-[189px] flex flex-col justify-center bg-gray-800 rounded-xl">
  ...
  return (
    <div className="px-4 backdrop-blur-[210px] bg-gradient-to-b from-5% from-[#011504] to-75% to-[#3F803C] py-5 flex items-center gap-3 rounded-xl flex-1 relative overflow-hidden md:gap-5 xl:gap-8">
      <div className="w-[104px] h-[104px] xl:w-[149px] xl:h-[149px] z-10">
        <CircleProgress
          bgClassName="stroke-white opacity-5"
          mainClassName="stroke-neon-1"
          secondaryClassName="stroke-[#E0FF88]/[0.55] blur-[3px]"
          value={clampedProgress}
          minValue={0}
          maxValue={100}
        >
          <div className="w-[72px] h-[72px] xl:w-[103px] xl:h-[103px] bg-gray-700 rounded-full flex items-center justify-center">
            <img
              src={levelImage}
      ...
      <div className="flex-1">
        <p className="font-bold text-lg xl:text-2xl mb-1 text-white">
          {loyaltyLevelName}
        </p>
        ...
        <div className="flex gap-2">
          <div className="flex flex-col flex-1">
            <span className="text-xs xl:text-base">Lifetime Coins</span>
