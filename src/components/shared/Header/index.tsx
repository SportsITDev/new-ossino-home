...
const Header = () => {
  ...
  return (
    <header
      className={cn(
        'w-full fixed md:sticky transition-all duration-300 top-0 z-[100] px-4 pt-4 pb-5 md:pr-4 xl:px-5 xl:pl-0 bg-black',
    ...
    >
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex h-10 w-full items-center justify-end gap-2 pl-4">
          <div className="hidden xl:flex w-full justify-between">
            <Switch />
            <ActionsBlock />
          </div>
          <div className="h-10 flex gap-1 justify-end">
            <div className="relative flex h-full gap-1">
              ...
              >
                ...
                />
                <span className="hidden xl:block pl-2 text-black text-xs font-medium">
                  Deposit
                </span>
              </Button>
            </div>
