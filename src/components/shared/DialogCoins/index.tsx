        ...
        <div className="flex flex-col items-center">
          <div className="relative max-w-56 w-full aspect-square flex justify-center items-center mb-8">
            <img
              ...
              alt=""
            />
            <div className="w-[73px] h-[73px] rounded-full bg-neon-1 flex flex-col justify-center items-center relative z-20">
              <span className="text-black text-2xl leading-[24px] font-bold">
                {value}
              </span>
              <span className="text-black leading-[16px] font-medium">
                {currency}
              </span>
            </div>
            <img
          ...
          <p className="text-sm md:text-base mb-6 text-center text-gray-200">
            {description}&nbsp;
            <span className="text-neon-1 text-base md:font-bold">
              {value}&nbsp;{currency}
            </span>
          </p>
