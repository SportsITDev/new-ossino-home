...
const MissionCard = ({
  ...
  return (
    <div className="overflow-hidden w-full h-full rounded-t-xl flex flex-col">
      ...
      />
      <div className="border border-t-0 border-white/[0.1] py-3 px-2 rounded-b-xl relative shadow-[0_15px_30px_0_#00000080] bg-gray-800 flex-1">
        <div
          style={{ backgroundImage: `url(${data.imageUrl})` }}
          className="aspect-square absolute w-[90px] blur-[50px] -top-20 left-1/2 -translate-x-1/2"
        />
        <div className="relative z-10 flex flex-col justify-between h-full">
          <p className="font-medium text-sm line-clamp-2 mb-1 flex-1 text-white">
            {data.description}
          </p>
          <p className="text-gray-400 font-medium text-xs">{data.brandId}</p>
          ...
          <Button
            ...
            className={cn(
              ...
              data.prizeAwarded
                ...
                : 'bg-neon-1 text-black',
              'disabled:pointer-events-none disabled:text-gray-500 disabled:bg-neon-1 disabled:opacity-20',
            )}
