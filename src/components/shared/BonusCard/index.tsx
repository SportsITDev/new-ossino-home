...
const MiniCard = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center border border-[#FFFFFF1A] px-2 py-4 rounded-[4px] w-24">
    ...
    <div className={cn('p-5 flex flex-col rounded-[12px] w-full ', className)}>
      <h1 className="flex item justify-between items-center pb-2">
        <div className="flex flex-col font-black">
          <span className="text-neon-1 text-[26px]">{discount}</span>
          <span className="text-sm uppercase">Casino bonus</span>
        </div>
        <Button className="w-[98px] h-8 text-xs bg-gradient-to-r from-lime-green to-bright-green">
          Claim Bonus
        </Button>
      </h1>
