      ...
      <div className="flex mb-4 gap-2">
        ...
        <Button
          ...
          className={`h-10 w-10 flex items-center justify-center rounded-lg p-0 relative ${
            hasActiveFilters ? 'bg-neon-1 text-black' : 'bg-gray-700'
          }`}
        >
      ...
      <div className="flex flex-col gap-2">
        {isLoading ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-400 text-sm">Loading referral details...</p>
          </div>
        ) : !hasAnyData ? (
          <div className="text-center py-8">
            <div className="bg-gray-800 rounded-xl p-6">
              <Icon
                id="searchIcon"
                href={searchNormal}
                className="w-12 h-12 stroke-gray-500 mx-auto mb-3"
              />
