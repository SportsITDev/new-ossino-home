...
const Footer = () => {
  ...
  return (
    <>
      <FooterContentSheet />
      <footer className="ios footer-container flex xl:hidden flex-col gap-6 mt-2 md:mt-14 lg:mt-[52px] px-4 md:px-8 lg:px-5 pb-14 text-gray-400 text-xs leading-4s">
        <img
      ...
      <footer
        className={cn(
          'footer-container hidden xl:flex flex-col gap-6 mt-2 md:mt-14 lg:mt-[52px] px-4 lg:px-8 pb-14 text-gray-400 text-xs leading-4s transition-all duration-300',
          {
