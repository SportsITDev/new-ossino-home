...
const FooterContentSheet = () => {
  ...
  return (
    <Sheet open={dialogState.open} onOpenChange={handleOpenChange}>
      <SheetContent className="inset-x-0 top-auto md:top-0 md:left-auto bottom-0 h-[90.6%] md:h-full pb-[60px] px-4 md:px-8 xl:border-l xl:border-gray-700 max-w-full md:max-w-[400px] w-full">
        <SheetTitle hidden />
        ...
        <div className="flex items-center gap-2 mb-5">
          <SheetClose className="w-8 h-8 border border-gray-700 rounded-lg flex items-center justify-center">
            ...
            {screenWidth > BREAKPOINTS.md ? (
              ...
              <Icon id="arrowLeftIcon" href={arrowLeft} className="w-4 h-4" />
            )}
          </SheetClose>
          <div className="inline-flex items-center justify-center text-sm text-neon-2 font-medium h-8 px-4 bg-gray-800 rounded-lg">
            {title}
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="prose prose-invert max-w-none">
            <div
              className="markdown text-gray-300"
