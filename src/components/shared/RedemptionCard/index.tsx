...
const RedemptionCard = ({
  ...
  return (
    <div className="rounded-xl overflow-hidden w-full bg-gray-800 relative">
      <img
        src={data.href}
      ...
      <div className="p-2 pb-3 flex flex-col items-center relative z-10">
        <p className="font-bold mb-2 text-sm text-white">{data.name}</p>
      ...
      <div className="absolute bg-gradient-to-b from-5% from-[#011504] to-70% to-[#3F803C] w-[370px] h-[580px] rounded-full blur-[100px] rotate-[-150deg] bottom-[-400px] right-[-320px]" />
    </div>
  );
};
