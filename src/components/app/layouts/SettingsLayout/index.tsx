  ...
  return (
    <div className="pb-[72px] md:pb-28 xl:pb-16 pt-[75px] md:pt-0 min-h-screen md:min-h-fit">
      <div className="flex gap-2 items-center mb-5 px-4 xl:mt-5">
        <Link
          to="/"
          className="bg-gray-800 flex justify-center items-center rounded-lg w-8 h-8"
        >
          <Icon
            id="arrowLeftIcon"
            href={arrowLeft}
        ...
        <div className="bg-gray-800 rounded-lg h-8 px-4 flex items-center w-fit text-sm font-medium text-neon-2 capitalize">
          Settings
        </div>
      </div>
      <div className="px-4 xl:px-5">
        <div className="xl:bg-gray-800 xl:rounded-xl xl:p-5 xl:min-h-[666px]">
            ...
            >
              {options.map(({ label, to }) => (
                <Link
                  ...
                  to={to}
                  className={cn(
                    'bg-gray-750 min-w-[87px] flex-shrink-0 xl:w-[148px] px-[18.5px] rounded-xl h-10 text-xs leading-4 flex items-center justify-center',
                    {
                      'border border-neon-2 font-medium text-neon-2':
