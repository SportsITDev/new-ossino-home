...
const Vip = () => {
  ...
  if (vipDataLoading) {
    return (
      <div className="rounded-xl p-4 pb-5 bg-gray-800 flex items-center justify-center min-h-[108px]">
    ...
    >
      <div className="relative z-10">
        ...
        {layout === 'default' && (
          <Button
            ...
            className="xl:hidden flex items-center w-fit h-8 px-2 bg-neon-1 text-xs font-medium text-black"
          >
            Create Now
          </Button>
        )}
      ...
      >
        ...
        <Icon
          id="crown2Icon"
          href={crown}
          className="h-10 w-10 fill-current text-white absolute top-2 left-6"
        />
      </div>
      <img
