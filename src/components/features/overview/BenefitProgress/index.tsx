    ...
    <div className="space-y-2">
      ...
      <div className="flex justify-between text-xs text-gray-200 font-medium">
        ...
        {remainingPoints > 0 && (
          <p className="text-gray-400">
            Earn{' '}
            <span className="font-semibold text-white">{remainingPoints}</span>{' '}
            More Point
      ...
      <div className="relative">
        <Progress
          value={percentage}
          className={cn(
            'h-3 bg-gray-600 transition-all duration-300 shadow-inner rounded-full overflow-hidden',
            {
      ...
      <div className="flex items-center justify-between gap-2 text-xs">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-gray-300">{totalPoints}</span>
        </div>
      </div>
    </div>
  );
