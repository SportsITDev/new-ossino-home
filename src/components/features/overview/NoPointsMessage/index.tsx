...
const NoPointsMessage = () => {
  return (
    <div className="flex flex-col items-center xl:w-full xl:flex-row xl:gap-3 xl:bg-[#1C1C1C] xl:rounded-xl xl:px-4 xl:py-6">
      {/* <img
        src={giftIcon}
        alt="gift"
        width={32}
      ...
      <svg className="w-8 h-8 fill-current">
          <use className="fill-current text-gray-300" href="/icons/gift.svg#giftIcon"></use>
      </svg>
      <div className='xl:grow'>
        <p className="text-xs leading-4 text-gray-300 mb-3 xl:mb-0 text-center xl:text-left max-w-[220px] xl:max-w-[240px]">
