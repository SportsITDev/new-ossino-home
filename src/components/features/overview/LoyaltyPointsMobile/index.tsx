  ...
  return (
    <Accordion type="single" collapsible className="w-full h-full">
      <AccordionItem value="item-1" className="w-full h-full flex flex-col">
        <AccordionTrigger className="p-4 bg-gray-800 rounded-xl data-[state=open]:rounded-b-none">
          <div className="flex items-center gap-1">
            <h3 className="font-bold">Loyalty Points</h3>
            <Icon
              href={infoIcon}
              id="infoIcon"
              className="w-4 h-4 text-gray-400 mt-[2px]"
            />
          </div>
        </AccordionTrigger>
        <AccordionContent className="h-full bg-gray-800 rounded-b-xl p-4 pt-0">
