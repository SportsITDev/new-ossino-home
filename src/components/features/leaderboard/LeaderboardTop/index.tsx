          ...
          ({ place, username, avatar, value, id }, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-5 h-5 rounded-full bg-black flex items-center justify-center mb-1">
                  <span className="font-bold text-xs">{place}</span>
                </div>
                <p
                  className="text-xs text-gray-200 break-words max-w-[120px] truncate text-center"
                  title={displayUsername}
                >
                  {displayUsername}
                </p>
                <span className="text-neon-1 text-sm font-medium">
                  {formatNumber(value)}
                </span>
              </div>
            );
