        ...
        {(() => {
          ...
          for (let i = 0; i < leaderboard.length && rows.length < N; i++) {
            ...
            rows.push(
              <TableRow
                className={cn(
                  '[&>td]:bg-gray-800 [&>td:first-child]:rounded-l-xl [&>td:last-child]:rounded-r-xl',
                  {
                    '[&>td]:border-y [&>td:last-child]:border-r [&>td:first-child]:border-l [&>td]:border-neon-1':
                      currentUser,
                    'xl:[&>td]:border-y xl:[&>td:last-child]:border-r xl:[&>td:first-child]:border-l xl:[&>td]:border-gray-700':
                      !currentUser,
                  },
                )}
                key={id}
              ...
              >
                ...
                <TableCell className="font-medium text-end text-neon-1">
                  {formatNumber(value)}
                </TableCell>
              </TableRow>,
            );
            ...
            if (lastVisible && userRow.place > lastVisible.place + 1) {
              rows.push(
                <TableRow key="skeleton-row">
                  <TableCell className="text-start rounded-l-lg w-[52px] bg-gray-900 animate-pulse">
                    &nbsp;
                  </TableCell>
                  <TableCell className="bg-gray-900 animate-pulse">
                    &nbsp;
                  </TableCell>
                  <TableCell className="bg-gray-900 animate-pulse">
                    &nbsp;
