...
const ReferralDetails = () => {
  ...
  return (
    <div>
      <h2 className="mb-3 text-white font-bold xl:text-lg xl:mb-4">Details</h2>
      <div className="flex gap-2 xl:flex-col h-36 md:h-32">
        <div className="rounded-xl flex flex-col justify-center items-center w-1/2 md:w-1/3 xl:w-full bg-gray-800 px-3 xl:border xl:border-gray-700 xl:h-fit xl:px-4 xl:py-5 xl:items-start">
          <p className="text-gray-400 text-xs xl:text-sm">Total Referrals</p>
        ...
        <div className="w-1/2 md:w-2/3 xl:w-full flex flex-col gap-2 md:flex-row">
          <div className="flex-1 px-3 bg-gray-800 rounded-xl flex flex-col justify-center md:items-center xl:items-start xl:border xl:border-gray-700 xl:px-4 xl:py-5">
            <p className="text-gray-400 text-xs xl:text-sm">Total Wagered</p>
            <p className="text-sm font-medium xl:text-base">
