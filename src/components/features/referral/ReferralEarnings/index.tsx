  ...
  return (
    <div className="xl:p-5 xl:rounded-xl xl:bg-gray-800 xl:min-h-full">
      ...
      <div className="flex gap-3 mb-3">
        <div className="flex-1 px-3 py-5 bg-gray-800 rounded-xl xl:border xl:border-gray-700 md:h-32 md:flex md:flex-col md:justify-center md:items-center xl:items-start xl:h-fit">
          <p className="text-gray-400 text-xs xl:text-sm">Total Claimed</p>
          <p className="text-sm font-medium">
            ${formatNumber(earningsData.totalClaimed, 2)}
          </p>
        </div>
        <div className="flex-1 px-3 py-5 bg-gray-800 rounded-xl xl:border xl:border-gray-700 md:h-32 md:flex md:flex-col md:justify-center md:items-center xl:items-start xl:h-fit">
          <p className="text-gray-400 text-xs xl:text-sm">Total Claimable</p>
          <p className="text-sm font-medium">
        ...
        {earningsData.earnings.length > 0 ? (
          earningsData.earnings.map(({ id, value, currency }) => (
            ...
            >
              ...
              <p className="text-sm text-gray-200 ml-1">
                {cryptoOptions[currency].label}
              </p>
              <p className="ml-auto text-neon-1 font-medium text-sm">
