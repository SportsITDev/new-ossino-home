...
const PersonalInfoAccordion = () => {
  return (
    <AccordionItem
      disabled
      value="personal-info"
      className='rounded-xl xl:border xl:border-gray-700'
    >
      <AccordionTrigger className="data-[state=open]:pb-2 p-4 bg-gray-800 xl:bg-none rounded-xl data-[state=open]:rounded-b-none">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 flex items-center justify-center bg-gray-700 rounded-full">
            <Icon href={user} id="userIcon" className="w-5 h-5" />
          </div>
