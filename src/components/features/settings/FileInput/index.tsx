...
const FileInput = ({
  ...
  return (
    <>
      <div
        className="h-10 bg-gray-700 rounded-lg flex items-center gap-2 cursor-pointer mb-1"
        onClick={handleClick}
      >
        <div className="bg-gray-600 inline-flex items-center justify-center h-full px-2 rounded-l-lg">
