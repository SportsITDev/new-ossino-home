...
const EmailVerificationAccordion = () => {
  ...
  return (
    <AccordionItem value="email-verification" className='rounded-xl xl:border xl:border-gray-700 bg-gray-800 xl:bg-none'>
      <AccordionTrigger className="data-[state=open]:pb-2 p-4">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 flex items-center justify-center bg-gray-700 rounded-full">
            <Icon href={sms} id="smsIcon" className="w-5 h-5" />
          </div>
