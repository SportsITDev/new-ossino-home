  ...
  return (
    <>
      <img
        ...
        alt=""
      />
      <p className="text-xl mb-2 text-center font-bold text-white">
        {data.name}
      </p>
      ...
      <p className="text-sm text-gray-200 mb-6 text-center max-w-60 md:text-base md:max-w-64">
        {data.description}
      </p>
      <div className="rounded-lg h-8 bg-white/[0.1] w-full flex items-center justify-between px-4 mb-3">
        <span className="text-xs font-medium text-gray-200">Coin Balance</span>
...
const SecondStepView = ({ data, onClick }: StepViewProps) => {
  ...
  return (
    <>
      ...
      <h2 className="text-xl font-bold mb-1 text-white">Congratulations!</h2>
      <p className="text-sm md:text-base text-center mb-6 text-gray-200">
