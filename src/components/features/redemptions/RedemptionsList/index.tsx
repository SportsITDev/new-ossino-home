...
const RedemptionList = () => {
  ...
  if (redemptionsError) {
    ...
    return (
      <div className="flex h-[300px] flex-col justify-center xl:px-5 xl:py-[22.5px] xl:bg-gray-800 xl:rounded-xl">
  ...
  if (redemptionsLoading) {
    return (
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-7 gap-3 xl:p-5 xl:bg-gray-800 xl:rounded-xl">
