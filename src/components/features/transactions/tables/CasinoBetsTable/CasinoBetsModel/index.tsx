    ...
    return (
        ...
        >
            <div className="flex justify-center items-center gap-1 mb-6">
                <IoGameControllerOutline size={20} className="text-white mt-1" />
                <span className="text-xl text-white leading-none capitalize">{gameNameValue}</span>
            </div>
            <div className="flex flex-col lg:flex-row items-center justify-center h-[35px] w-full gap-1">
                <div className="flex items-center justify-center gap-2 h-[35px]">
                    <span>Placed by:</span>
                    <span className="bg-gray-700 text-gray-300 flex items-center rounded px-3 gap-2 h-full">
                    ...
                    {!isLoading ? (
                        <div className="min-w-[600px]">
                            <div className="table-header flex min-w-[500px]">
                                <div className="flex-[0.5] leading-[18px] text-xs lg:text-sm text-gray-300 font-medium h-11 flex items-center justify-center">
                                    Txn. ID
                                </div>
                                <div className="flex-[0.25] text-xs lg:text-sm text-gray-300 font-medium h-11 flex items-center justify-center">
                                    Amount
                                </div>
                                <div className="flex-[0.25] text-xs lg:text-sm text-gray-300 font-medium h-11 flex items-center justify-center">
                                    Type
                            ...
                            <div className="table-content flex flex-col gap-2 min-w-[500px]">
                                {casinoBetRoundsFromServer?.map((round) => {
                                    ...
                                    return (
                                        <div
                                            key={round.betId}
                                            className="flex justify-start items-center box-border h-11 text-sm border bg-gray-700 border-gray-800 rounded-xl min-w-[500px]"
                                        >
