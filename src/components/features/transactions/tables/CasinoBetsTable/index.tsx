        ...
        <div className="shadow-wrapper relative">
            ...
            >
                <div className={cn("table-header flex flex-row justify-start gap-0", { "md:border-b md:border-b-gray-700": !sortedBets.length })}>
                    <div className="flex text-xs items-center text-gray-300 h-11 min-w-[85px]  lg:w-[260px] font-medium leading-4">
                        <SortingColumn
                    ...
                    <div className="flex text-xs pl-3 items-center justify-start text-gray-300 h-11 font-medium min-w-[150px]  lg:w-[300px] text-center leading-4 lg:ml-2">Game Name</div>
                    <div className="flex text-xs items-center min-w-[120px]  lg:w-[200px] text-gray-300 h-11 font-medium leading-4">
                        <SortingColumn
                            label="Amount"
                    ...
                    <div className="flex text-xs items-center min-w-[300px]  lg:w-[450px] text-gray-300 h-11 font-medium leading-4">
                        <span className="inline-block lg:hidden text-gray-300">Round ID</span>
                        {isDesktopScreen && (
                            <SortingColumn
                                label="Round ID"
                    ...
                    <div className="flex text-xs items-center min-w-[120px]  lg:w-[230px] text-gray-300 h-11 font-medium leading-4">
                        <SortingColumn
                            label="Payout"
                    ...
                    <div className="flex text-xs items-center ml-auto justify-center text-gray-300 h-11 font-medium min-w-[48px] lg:w-[100px] text-center leading-4">Status</div>
                </div>
