  ...
  return (
    <div className="shadow-wrapper relative">
      <div
        ...
        ref={containerRef}
      >
        <div className={cn("table-header flex flex-row justify-start", { "border-b border-b-gray-700": !sortedTips.length })}>
          <div className="flex text-xs items-center text-gray-300 h-11 w-[140px] xl:w-[300px] font-medium leading-4">
            <SortingColumn 
              label='Date' 
          ...
          <div className="flex flex-row md:w-2/3 lg:w-full gap-0">
            <div className="flex items-center text-gray-300 h-11 font-medium leading-4 w-[135px] md:w-1/2 gap-1.5">
              <SortingColumn 
            ...
            <div className="flex text-xs items-center min-w-[140px] md:w-1/2 text-gray-300 h-11 font-medium leading-5">
              <span className="text-gray-300 inline-block xl:hidden">User</span>
              {isDesktopScreen && (
                <SortingColumn 
                  label='User' 
          ...
          <div className="flex text-xs items-center justify-center text-gray-300 h-11 font-medium min-w-[48px] xl:min-w-[100px] text-center leading-4 ml-auto">Status</div>
