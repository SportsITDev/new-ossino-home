...
const DepositTable = () => {
  ...
  const tableHeaderClasses = cn(
    ...
    {
      'md:border-b md:border-b-gray-700':
    ...
    <div className="shadow-wrapper relative">
      ...
      >
        <div className={tableHeaderClasses}>
          <div className="flex flex-row text-xs items-center text-gray-300 h-11 w-[140px] xl:w-[320px] font-medium leading-4">
            <SortingColumn
              label="Date"
          ...
          <div className="flex text-xs items-center text-gray-300 h-11 font-medium leading-4">
            <SortingColumn
              label="Amount"
          ...
          <div className="flex text-xs items-center justify-center text-gray-300 h-11 font-medium w-[48px] xl:w-[100px] text-center leading-4 ml-auto">
            Status
          </div>
        </div>
