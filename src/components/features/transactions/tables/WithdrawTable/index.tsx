      ...
      >
        <div
          className={cn(
            ...
            { 'md:border-b md:border-b-gray-700': !withdrawalsFromServer.length },
          )}
        >
          <div className="flex text-xs items-center text-gray-300 h-11 min-w-[120px] md:w-1/3 xl:min-w-[320px] font-medium leading-4">
            <SortingColumn
              label="Date"
          ...
          <div className="flex flex-row md:w-2/3 xl:w-full gap-0">
            <div className="flex text-xs items-center min-w-[130px] md:w-1/2 text-gray-300 h-11 font-medium leading-4">
              <SortingColumn
                label="Amount"
            ...
            <div className="flex text-xs items-center min-w-[100px] md:w-1/2 text-gray-300 h-11 font-medium leading-4">
              <span className="md:hidden inline-block text-gray-300">
                Transaction ID
              </span>
              {!isMobileScreen && (
                <SortingColumn
          ...
          <div className="flex text-xs items-center justify-center text-gray-300 h-11 font-medium md:min-w-[48px] xl:min-w-[100px] text-center leading-4 ml-auto">
            Status
          </div>
        </div>
