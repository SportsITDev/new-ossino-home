...
const WithdrawItem = ({ withdrawItem }: WithdrawItemProps) => {
  ...
  return (
    <div className="flex flex-row no-scrollbar overflow-visible justify-start items-center bg-gray-800 box-border w-fit md:w-auto h-11 border border-gray-800 xl:border-gray-700 rounded-xl pl-0 pr-0">
