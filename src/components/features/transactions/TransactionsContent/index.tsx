...
const TransactionsContent = () => {
  ...
  return (
    <div className="p-0 xl:p-5 rounded-xl xl:bg-gray-800 xl:rounded-xl">
      <div className="shadow-wrapper relative">
        ...
        >
          <div className="category-buttons flex flex-row md:w-auto gap-2 mb-[10px]">
            <Button
              className={cn(
                'md:w-auto xl:w-[148px] px-4 py-3 h-10 font-normal rounded-xl bg-gray-750 text-white text-xs border border-transparent',
                { 'border-neon text-neon': category === CATEGORY.Deposit }
              )}
              variant='outline'
              onClick={() => {
            ...
            <Button
              className={cn('md:w-auto xl:w-[148px] px-4 py-3 h-10 font-normal rounded-xl bg-gray-750 text-white text-xs border border-transparent', { 'border-neon text-neon': category === CATEGORY.Withdraw })}
              variant='outline'
            ...
            <Button
              className={cn('md:w-auto xl:w-[148px] px-4 py-3 h-10 font-normal rounded-xl bg-gray-750 text-white text-xs border border-transparent', { 'border-neon text-neon': category === CATEGORY.SportsBets })}
              variant='outline'
            ...
            <Button
              className={cn('md:w-auto xl:w-[148px] px-4 py-3 h-10 font-normal rounded-xl bg-gray-750 text-white text-xs border border-transparent', { 'border-neon text-neon': category === CATEGORY.CasinoBets })}
              variant='outline'
            ...
            <Button
              className={cn('md:w-auto xl:w-[148px] px-4 py-3 h-10 font-normal rounded-xl bg-gray-750 text-white text-xs border border-transparent', { 'border-neon text-neon': category === CATEGORY.Tips })}
              variant='outline'
              onClick={() => {
