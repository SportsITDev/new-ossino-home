...
const QrBlock = ({ walletNumber }: QrBlockProps) => {
  ...
  return (
    <div className="p-4 h-[390px] flex flex-col gap-8 items-center justify-center pt-[38px] border border-gray-700 rounded-xl">
      <div className="flex flex-col gap-2 items-center">
        ...
        <Link to='/transactions'>
          <button type='button' onClick={handleHistoryClick}>
            <p className="text-sm leading-[18px] font-medium text-neon-2">
              Deposit History
            </p>
          </button>
        </Link>
