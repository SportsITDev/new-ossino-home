...
const TipDialog = ({ username, amount, currency }: TipDialogProps) => {
      ...
      <DialogContent variant="success" className="md:min-w-[400px] xl:min-w-[400px] h-auto">
        <DialogHeader className='flex flex-col gap-8'>
          <div className="relative w-[220px] h-[220px] mx-auto flex items-center justify-center">
            ...
            />
            <div className="z-10 w-24 h-24 rounded-full bg-[#FFFFFF33] flex items-center justify-center">
              <Icon href={yellowWallet} id='yellowWalletIcon' className='w-10 h-10' />
            </div>
          </div>
          <div className="mx-0">
            ...
            <DialogDescription>
              You have successfully tipped @{username} with {amount} {currency}
            </DialogDescription>
          </div>
        </DialogHeader>
