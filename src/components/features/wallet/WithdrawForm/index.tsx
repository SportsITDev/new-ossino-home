              ...
              <FormItem className="mb-3">
                ...
                <FormControl>
                  <Select
                    ...
                    dropDownClassName="w-full bg-gray-700"
                  ...
                  >
                    <div className="ml-1.5 flex w-full items-center justify-between gap-1.5">
                      ...
                      <span className="flex-1 text-right text-xs leading-4">
                        {formatNumber(+currency.balance, 10)}
                      </span>
                    </div>
                  </Select>
                </FormControl>
                  ...
                  <div className="relative mx-[2px]">
                    ...
                    <div onClick={() => setWalletAddress('')}>
                      <Icon
                        id="refreshIcon"
                        href={refreshIcon}
                        className="absolute right-3 top-1/3 w-4 h-4 cursor-pointer text-gray-500 hover:text-gray-700"
                      />
                    </div>
                  </div>
                </FormControl>
              ...
              <FormItem className="mb-4">
                <FormLabel>
                  <div className="flex w-full justify-between">
                    <span>Amount</span>
                    <span>{`${field.value ? formatNumber(+field.value.replace(/,/g, '')) : '0.00'} ${currency.contraction}`}</span>
                  </div>
                </FormLabel>
                <FormControl>
                  <Controller
                    ...
                    render={({ field }) => (
                      <div className="relative mx-[2px]">
                        <IMaskInput
                          ...
                          mapToRadix={['.', ',']}
                          normalizeZeros
                          className="w-full pl-[38px] items-center justify-center flex h-10 rounded-lg bg-gray-700 p-3 text-sm placeholder:text-gray-500 text-white focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neon-1"
                          placeholder="Enter Value"
                        ...
                        <span className="absolute left-3 top-1/3 w-4 h-4 cursor-pointer text-gray-500 hover:text-gray-700">
                          {currency.icon}
                        </span>
                      </div>
                    )}
                  ...
                  <div className="mt-1 flex flex-col gap-1 justify-center">
                    <div className="flex flex-row gap-1 items-center">
                      <Icon
                        ...
                        className="w-4 h-4"
                      />
                      <span className="font-medium text-white text-10px leading-[13px]">
