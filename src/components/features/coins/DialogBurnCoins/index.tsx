...
const FirstStepView = ({ 
  ...
  return (
    <>
      <div className="h-24 w-24 bg-gray-700 mb-8 rounded-full flex items-center justify-center">
        <Icon id="fire2Icon" href={fire2} className="w-10 h-10" />
      </div>
      ...
      <div className="mb-6 text-center">
        <p className="text-gray-200 mb-2">
          ...
          <span className="text-base font-bold text-neon-1">
    ...
    <>
      <div className="relative max-w-56 w-full aspect-square flex justify-center items-center mb-8">
        <img
          ...
          alt=""
        />
        <div className="w-[90px] h-[90px] rounded-full bg-neon-1 flex flex-col justify-center items-center relative z-20">
          <span className="text-black text-lg leading-[18px] font-bold">
            ₮{actualCashback}
          </span>
          <span className="text-black text-xs leading-[14px] font-medium">
            cashback
          </span>
        </div>
        <img
      ...
      <p className="text-sm md:text-base mb-2 text-center text-gray-200">
        Successfully burned&nbsp;
        <span className="text-neon-1 font-bold">
          {value}&nbsp;coins
        </span>
      </p>
      <p className="text-sm md:text-base mb-6 text-center text-gray-200">
        Your account has been credited with&nbsp;
        <span className="text-neon-1 text-base font-bold">
...
const DialogBurnCoins = () => {
  ...
  return (
    <Dialog open={!!open} onOpenChange={close}>
      {data?.value ? (
        <DialogContent className="max-w-80 md:max-w-[400px] p-4 pt-8 bg-gray-900">
