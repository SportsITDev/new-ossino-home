...
const OverviewItem = ({ option, value }: { option: Option; value: number }) => {
  ...
  return (
    <div
      ...
      className="p-4 border border-gray-700 rounded-lg flex gap-1 xl:border-none xl:rounded-xl xl:flex-col xl:items-center xl:justify-center xl:flex-1 xl:bg-[#1C1C1C]"
    >
      {option.icon}
      <span className="text-sm text-gray-200 xl:text-white xl:text-xs">
        {option.label}
      </span>
      <span className="ml-auto font-medium text-neon-1 text-sm xl:ml-0">
...
const OverviewItemSkeleton = () => {
  return (
    <div className="p-4 border border-gray-700 rounded-lg flex gap-1 xl:border-none xl:rounded-xl xl:flex-col xl:items-center xl:justify-center xl:flex-1 xl:bg-[#1C1C1C]">
  ...
  if (coinsOverviewError) {
    ...
    return (
      <>
        ...
        <div className="rounded-xl bg-gray-800 px-4 xl:hidden">
