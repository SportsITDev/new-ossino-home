...
const BurnCoins = () => {
  ...
  if (!loyaltyDetails) {
    return (
      <div className="p-4 bg-gray-800 rounded-xl xl:p-5">
        <p className="text-white font-bold xl:text-lg mb-2">Burn Coins into Cashback</p>
        <p className="text-xs text-gray-200 mb-4">Loading your loyalty data...</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 bg-gray-800 rounded-xl xl:p-5">
      <div className="flex justify-between items-center mb-2">
        <p className="text-white font-bold xl:text-lg">
          Burn Coins into Cashback
        </p>
      </div>
      <p className="text-xs text-gray-200 mb-4 max-w-[300px]">
        You will get Instant Cashback credited to your wallet immediately.
      </p>

      {expectedCashback > 0 && (
        <div className="mb-4 p-3 bg-gray-700 rounded-lg">
          <p className="text-sm text-gray-200">Expected Cashback:</p>
          <p className="text-lg font-bold text-neon-1">
          ...
          <FormField
            ...
            render={({ field, fieldState }) => (
              <FormItem className="mb-4">
                <FormDescription className="text-neon-1">
                  1 coin = 	₮
