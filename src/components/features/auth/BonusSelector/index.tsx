...
const BonusSelector = ({
  ...
  return (
    <>
      ...
      />
      <div>
        <p className="text-xs leading-4 font-regular text-gray-200 mb-3 max-w-[250px] lg:max-w-[300px]">
          By choosing a bonus, you confirm that you have read and accept the
          policy of{' '}
          {sportsLink ? (
            <button
              onClick={(e) => handleLinkClick(e, sportsLink)}
              className="font-medium underline hover:text-white transition-colors cursor-pointer"
            >
