...
const ChatInput = ({ ws, usersCount }: ChatInputProps) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 p-4 pt-6 right-0 flex flex-col gap-4 w-full box-border bg-gray-800 border-top-greyscale rounded-t-xl">
      ...
      {showEmojiPicker ? (
        ...
        <div className="flex flex-row justify-between">
          <div className="flex gap-[6px] items-center">
            <span className="inline-block h-[5px] w-[5px] bg-bright-green rounded-full" />
            <p className="text-xs leading-4 font-medium text-gray-300">
              {usersCount} Online
            </p>
          </div>
