  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="!rounded-xl gap-4">
        <DialogHeader>
          <div className="mb-8 w-24 h-24 rounded-full bg-[#FFFFFF33] flex items-center justify-center mx-auto">
            <Icon href={buyCrypto} id="buyCryptoIcon" className="w-10 h-10" />
          </div>
          <DialogTitle className="mb-4 !mt-0 leading-5">
            Tip Information
          </DialogTitle>
          <DialogDescription className="flex items-center gap-2 w-full justify-center !mt-4">
            <span className="text-sm leading-4 font-bold text-neon-1">
              @{sender}
            </span>
            <span className="text-sm leading-[18px] text-gray-200">tipped</span>
            <span className="text-sm leading-4 font-bold text-neon-1">
              @{receiver}
            </span>
          </DialogDescription>
        </DialogHeader>
        <div className="bg-[#FFFFFF1A] rounded-xl px-4 py-3 flex items-center gap-2 justify-center">
