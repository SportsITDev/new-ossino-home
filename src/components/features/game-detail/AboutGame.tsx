  ...
  return (
    <>
      <Accordion
        type="single"
        collapsible
        className="px-4 bg-gray-800 rounded-xl block xl:hidden"
      >
      ...
      <div className="hidden xl:grid h-[506px] grid-cols-[2fr_1fr] gap-5 ">
        <div className="flex flex-col gap-3 pb-4 bg-gray-800 p-5 rounded-xl">
          <p className="text-sm font-regular">
            At Ossino, we’re giving away $10,000 every 24 hours. The question
            is: are you ready to race to the top?
          </p>
        ...
        <div className="bg-gray-800 rounded-xl p-5 overflow-y-auto ">
          <StatsBlock />
          <DailyRaceBlock />
        </div>
      </div>
