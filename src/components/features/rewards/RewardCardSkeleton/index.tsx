...
const RewardCardSkeleton = () => {
  return (
    <div className="w-[120px] bg-gray-800 md:bg-gray-700 h-[120px] md:w-[104px] md:h-[104px] xl:w-[150px] xl:h-[150px] rounded-lg flex flex-col justify-center items-center">
