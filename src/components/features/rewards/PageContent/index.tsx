    ...
    <div className="grid grid-cols-4 gap-2 mb-8 px-4 xl:mb-5 xl:px-5">
      {options.map(({ icon: Icon, label, route }) => (
        <div
          ...
          className="rounded-xl pt-3 pb-2.5 px-4 flex flex-col items-center gap-1 bg-[#1A1A1A] cursor-pointer hover:bg-[#2A2A2A] transition-colors duration-200 active:scale-95 transform transition-transform"
        >
          <Icon className="fill-neon-2" />
