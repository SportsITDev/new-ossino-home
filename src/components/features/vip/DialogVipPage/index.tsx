        ...
        <div className="flex flex-col items-center">
          <div className="relative max-w-56 w-full aspect-square flex justify-center items-center mb-8">
            <img
              ...
              alt=""
            />
            <div className="w-24 h-24 bg-gray-700 flex items-center justify-center rounded-full z-10">
              <Icon
                id="crown2Icon"
                href={crown}
          ...
          <p className="text-center text-gray-200 mb-11">
            You&apos;ve created your own VIP Page. Share link with friend to
            start earning.
          </p>
          <div
            className="px-3 rounded-lg border border-white mb-3 flex justify-between items-center cursor-pointer w-full h-10 text-sm"
            onClick={onCopy}
          >
            <span className="text-gray-100 text-sm">{url}</span>
