  ...
  return (
    <div className="flex flex-col gap-2 w-16 xl:w-20 text-center overflow-hidden font-bold ">
      <div className="flex flex-col m-0 justify-center items-center gap-2 relative aspect-square">
        <img
          className={cn(
            'absolute w-full h-full top-0 left-0 object-cover border border-transparent rounded-2xl xl:rounded-[24px] bg-transparent hover:border-lime-green cursor-pointer',
            { 'border-lime-green': selected },
          )}
          src={image}
          alt={title}
        />
