...
const HeroSkeleton = () => {
  return (
    <div className="relative mt-5  box-border max-w-full rounded-xl md:min-h-[375px] xl:min-h-[414px] text-center overflow-hidden w-screen">
      <div className="bg-gray-800 flex flex-col justify-end min-h-[360px] xl:min-h-[400px] rounded-xl">
              ...
              {Array.from({ length: 24 }).map((_, index) => (
                ...
                >
                  <div className="flex flex-col gap-2 justify-center items-center">
                    <Skeleton className="w-full bg-gray-600 aspect-square rounded-2xl xl:rounded-[24px]" />
                    <Skeleton className="w-16 bg-gray-600 rounded-xl h-[14px]" />
                  </div>
                </SwiperSlide>
              ))}
            </Slider>
