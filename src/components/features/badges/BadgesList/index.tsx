...
const BadgesList = ({ setSelectedBadge }: BadgesListProps) => {
  ...
  if (badgesError) {
    ...
    return (
      <div className="flex h-[201px] flex-col justify-center xl:px-5 xl:py-[22.5px] xl:bg-gray-800 xl:rounded-xl">
  ...
  if (badgesLoading) {
    return (
      <div className="grid grid-cols-3 md:grid-cols-6 xl:grid-cols-9 gap-3 md:gap-4 xl:px-5 xl:py-[22.5px] xl:bg-gray-800 xl:rounded-xl">
  ...
  return (
    <div className="grid grid-cols-3 md:grid-cols-6 xl:grid-cols-9 gap-3 md:gap-4 xl:p-5 xl:bg-gray-800 xl:rounded-xl">
