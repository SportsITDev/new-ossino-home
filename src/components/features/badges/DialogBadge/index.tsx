          ...
          <div className="flex flex-col items-center">
            <div className="max-w-36 w-full mb-7 animate-coin-flip">
              <CircleProgress
                ...
                minValue={0}
                maxValue={100}
                mainClassName="stroke-green-1"
                secondaryClassName="stroke-[#E0FF88]/[0.55] blur-[3px]"
                bgClassName="stroke-gray-700 opacity-1"
              >
                <div className="p-2">
                  <div className="rounded-full flex items-center justify-center overflow-hidden relative">
                    ...
                    />
                    {data.completed < 100 ? (
                      <div className="absolute h-full w-full top-0 left-0 backdrop-blur-[10px] bg-[#414141]/[0.70] rounded-full" />
                    ) : null}
                  </div>
                </div>
              </CircleProgress>
            ...
            <div className="flex items-center gap-1 mb-2">
              <Icon
                ...
                className={cn('w-[14px] h-[14px] fill-current', {
                  'text-gray-500': data.completed < 100,
                  'text-green-1': data.completed === 100,
                })}
              />
            ...
            <p className="text-sm text-gray-200 mb-6 text-center md:text-base">
              {data.description}
            </p>
            <Button
              variant="filled"
