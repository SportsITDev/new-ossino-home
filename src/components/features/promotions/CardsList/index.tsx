...
const CardList = ({ category, type }: CardListProps) => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:rounded-xl xl:grid-cols-3 gap-3 xl:gap-y-2.5 xl:bg-gray-800 xl:p-5 xl:pb-8">
        {cards.map((card) => (
          <div
            key={card.offer_id}
            className="bg-gray-800 rounded-xl xl:border xl:border-gray-700 cursor-pointer hover:bg-gray-750 transition-colors"
