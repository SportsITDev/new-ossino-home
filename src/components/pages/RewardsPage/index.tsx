  ...
  return (
    <>
      ...
      <div className="hidden xl:flex px-5 gap-5 overflow-hidden">
        <div className="rounded-xl p-5 pb-8 pr-0 bg-gray-800 flex-1 flex flex-col gap-9 w-[360px]">
          <Missions />
          <Badges />
          <RedemptionsSlider />
        </div>
        <div className="rounded-xl bg-gray-800 p-5 w-[350px] h-fit flex flex-col gap-5">
