  ...
  return (
    <div className="relative inline-block group cursor-pointer text-xs lg:text-sm leading-[18px]">
      ...
      <div className="absolute -top-6 left-1/2 hidden flex-col items-center text-center transform -translate-x-1/2 group-hover:flex z-50">
        <div className="bg-black text-white text-[12px] leading-[14px] rounded-md py-0.5 px-1.5 whitespace-nowrap border border-gray-600">
          {tooltipText}
        </div>
        <div className="w-0 h-0 border-l-4 border-r-4 border-t-4 border-l-transparent border-r-transparent border-t-black border-t-gray-300"></div>
      </div>
    </div>
  );
};
