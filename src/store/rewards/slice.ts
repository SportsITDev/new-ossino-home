...
export const getMissionRewards = createAppAsyncThunk(
  ...
  async (
    ...
    try {
      console.log('getMissionRewards thunk called with data:', data);
      const response = await missionsApi.getMissionRewards(data);
      console.log('getMissionRewards response:', response);
      console.log('getMissionRewards result:', response.result);
...
export const claimMissionReward = createAppAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      console.log('Claim API Key from env:', claimApiKey);
      ...
      console.log('Complete payload being sent:', requestPayload);
      ...
      console.log('Parsed success message:', displayMessage);
      ...
      dispatch(openDialog({
        ...
        data: {
          ...
          message: `You've won ${prizeAmount} Loyalty coins`,
          buttonText: 'Got it!'
        }
      }));
