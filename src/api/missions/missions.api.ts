...
class MissionsApi extends AxiosClient {
  ...
  async getMissionRewards(data: MissionRewardRequest): Promise<MissionRewardResponse> {
    console.log('Making API call to fetch mission rewards (no access token)');
    ...
    console.log('Mission rewards API response:', response.data);
  ...
  async claimMissionReward(data: ClaimRewardRequest): Promise<ClaimRewardResponse> {
    console.log('Making API call to claim mission reward');
    console.log('Base URL:', baseURL);
    console.log('Request data:', data);
    ...
    console.log('Claim mission reward API response:', response.data);
    return response.data;
  }
}
